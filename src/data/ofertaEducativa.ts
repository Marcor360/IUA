...
export const ofertaEducativa: ProgramaOferta[] = [
  {
    ...
    seoKeywords: ["secundaria iua", "estudiar secundaria en chalco", "secundaria privada en los reyes la paz", "secundaria con valores", "escuela secundaria estado de mexico", "mejor secundaria zona oriente", "inscripciones secundaria iua", "secundaria en Los Reyes", "secundaria privada", "secundaria con valores", "secundaria Estado de México"],
    ...
    banner: "/banners/patio-1-banner-recorte-1920x700.webp",
    recuadro: "/recuadros/patio-1-recuadro-recorte-900x900.webp"
  },
  {
    id: "bachillerato",
    slug: "bachillerato",
    ...
    seoKeywords: ["bachillerato iua", "bachillerato en chalco", "bachillerato en los reyes la paz", "preparatoria iua", "bachillerato privado estado de mexico", "estudiar prepa en chalco", "preparatoria con rvoe", "inscripciones bachillerato", "bachillerato en Chalco", "bachillerato en Los Reyes", "preparatoria IUA", "bachillerato privado"],
    ...
    campoLaboral: ["Continuidad académica hacia licenciatura.", "Preparación para áreas profesionales futuras.", "Desarrollo de habilidades académicas and vocacionales."],
    planEstudios: ["Matemáticas", "Comunicación", "Ciencias Sociales", "Ciencias Experimentales", "Orientación Vocacional"],
    banner: "/banners/los-reyes-banner-recorte-1920x700.webp",
    recuadro: "/recuadros/los-reyes-recuadro-recorte-900x900.webp"
  },
  {
    id: "derecho",
    slug: "derecho",
    ...
    seoKeywords: ["licenciatura en derecho", "estudiar derecho en chalco", "derecho en linea", "derecho ejecutivo sabados", "carrera de derecho iua", "universidad derecho los reyes", "abogacia", "universidades privadas derecho", "estudiar derecho en IUA", "derecho en línea", "derecho ejecutivo", "derecho en Chalco", "derecho en Los Reyes", "derecho con RVOE"],
    ...
    banner: "/banners/sala-abogados1-banner-recorte-1920x700.webp",
    recuadro: "/recuadros/sala-abogados1-recuadro-recorte-900x900.webp"
  },
  {
    id: "psicologia",
    slug: "psicologia",
    ...
    seoKeywords: ["licenciatura en psicologia", "estudiar psicologia en chalco", "psicologia en linea", "psicologia ejecutiva sabados", "carrera de psicologia iua", "universidad psicologia los reyes", "psicologia clinica", "universidades privadas psicologia", "estudiar psicología en IUA", "psicología en línea", "psicología ejecutiva", "psicología en Chalco", "psicología en Los Reyes", "psicología con RVOE"],
    ...
    banner: "/banners-edu/psicologia.webp",
    recuadro: "/banners-edu/psicologia.webp"
  },
  {
    id: "pedagogia",
    slug: "pedagogia",
    ...
    seoKeywords: ["licenciatura en pedagogia", "estudiar pedagogia en chalco", "pedagogia en linea", "pedagogia ejecutiva sabados", "carrera de pedagogia iua", "universidad pedagogia los reyes", "ciencias de la educacion", "docencia", "estudiar pedagogía en IUA", "pedagogía en línea", "pedagogía ejecutiva", "pedagogía en Chalco", "pedagogía en Los Reyes", "pedagogía con RVOE"],
    ...
    banner: "/banners-edu/pedagogia.webp",
    recuadro: "/banners-edu/pedagogia.webp"
  },
  {
    id: "arquitectura",
    slug: "arquitectura",
    ...
    seoKeywords: ["licenciatura en arquitectura", "estudiar arquitectura en chalco", "arquitectura en linea", "arquitectura ejecutiva sabados", "carrera de arquitectura iua", "universidad arquitectura los reyes", "diseño arquitectonico", "arquitectura rvoe", "arquitectura del paisaje", "estudiar arquitectura en IUA", "arquitectura en línea", "arquitectura ejecutiva", "arquitectura en Chalco", "arquitectura con RVOE"],
    ...
    banner: "/banners-edu/arquitectura.webp",
    recuadro: "/banners-edu/arquitectura.webp"
  },
  {
    id: "artes-culinarias",
    ...
    seoKeywords: ["licenciatura en artes culinarias", "estudiar gastronomia en chalco", "artes culinarias presencial", "carrera de gastronomia iua", "universidad gastronomia los reyes", "chef profesional", "estudiar cocina", "artes culinarias rvoe", "estudiar gastronomía", "artes culinarias IUA", "artes culinarias presencial", "gastronomía presencial", "gastronomía en Chalco", "gastronomía con RVOE"],
    ...
    banner: "/banners-edu/artes-culinarias-banner.png",
    recuadro: "/banners-edu/artes-culinarias-recuadro.png"
  },
  {
    ...
    seoKeywords: ["licenciatura en contaduria publica", "estudiar contaduria en chalco", "contaduria en linea", "contaduria ejecutiva sabados", "carrera de contaduria iua", "universidad contaduria los reyes", "contabilidad", "finanzas e impuestos", "estudiar contaduría en IUA", "contaduría en línea", "contaduría ejecutiva", "contaduría en Chalco", "contaduría en Los Reyes", "contaduría con RVOE"],
    ...
    banner: "/banners-edu/contaduria_publica.webp",
    recuadro: "/banners-edu/contaduria_publica.webp"
  },
  {
    ...
    seoKeywords: ["licenciatura en administracion de empresas", "estudiar administracion en chalco", "administracion de empresas en linea", "administracion ejecutiva sabados", "carrera de administracion iua", "universidad administracion los reyes", "gestion empresarial", "negocios", "estudiar administración en IUA", "administración de empresas en línea", "administración ejecutiva", "administración en Chalco", "administración en Los Reyes", "administración con RVOE"],
    ...
    banner: "/banners-edu/administracion_de_empresas.webp",
    recuadro: "/banners-edu/administracion_de_empresas.webp"
  },
  {
    id: "diseno-grafico",
    slug: "diseno-grafico",
    ...
    seoKeywords: ["licenciatura en diseño grafico", "estudiar diseño grafico en chalco", "diseño grafico en linea", "diseño grafico ejecutivo sabados", "carrera de diseño grafico iua", "universidad diseño los reyes", "diseño digital", "comunicacion visual", "estudiar diseño gráfico en IUA", "diseño gráfico en línea", "diseño gráfico ejecutivo", "diseño digital", "diseño gráfico en Chalco", "diseño gráfico con RVOE"],
    ...
    banner: "/banners-edu/diseno-grafico-banner.png",
    recuadro: "/banners-edu/diseno-grafico-recuadro.png"
  },
  {
    ...
    seoKeywords: ["licenciatura en lenguas extranjeras", "estudiar idiomas en chalco", "lenguas extranjeras en linea", "lenguas extranjeras ejecutivo sabados", "carrera de idiomas iua", "universidad lenguas los reyes", "traduccion e interpretacion", "estudiar ingles avanzado", "estudiar idiomas en IUA", "lenguas extranjeras en línea", "lenguas extranjeras ejecutiva", "licenciatura en idiomas", "traducción e interpretación", "lenguas extranjeras con RVOE"],
    ...
    banner: "/banners-edu/lenguas-extranjeras-banner.png",
    recuadro: "/banners-edu/lenguas-extranjeras-recuadro.png"
  },
  {
    ...
    seoKeywords: ["ingenieria en sistemas computacionales", "estudiar sistemas en chalco", "sistemas computacionales en linea", "ingenieria en sistemas ejecutivo sabados", "carrera de sistemas iua", "universidad ingenieria los reyes", "desarrollo de software", "programacion", "estudiar sistemas en IUA", "sistemas computacionales en línea", "ingeniería en sistemas ejecutiva", "desarrollo de software", "programación", "sistemas con RVOE"],
    ...
    banner: "/banners-edu/sistemas-computacionales-banner.png",
    recuadro: "/banners-edu/sistemas-computacionales-recuadro.png"
  },
  {
    ...
    seoKeywords: ["maestria en derecho penal", "estudiar posgrado en chalco", "maestria en derecho penal en linea", "maestria ejecutiva sabados", "posgrado derecho iua", "universidad maestria los reyes", "juicios orales", "especialidad en derecho penal", "estudiar derecho penal en IUA", "maestría en derecho penal en línea", "posgrado en derecho penal", "derecho penal ejecutivo", "maestría con RVOE"],
    ...
    banner: "/banners/sala-abogados2-banner-recorte-1920x700.webp",
    recuadro: "/recuadros/sala-abogados2-recuadro-recorte-900x900.webp"
  },
  {
    ...
    seoKeywords: ["maestria en educacion", "estudiar maestria en educacion en chalco", "maestria en educacion en linea", "maestria educacion ejecutiva sabados", "posgrado educacion iua", "universidad maestria los reyes", "gestion educativa", "innovacion educativa", "estudiar maestría en educación en IUA", "maestría en educación en línea", "posgrado en educación", "gestión educativa", "innovación educativa", "maestría con RVOE"],
    ...
    banner: "/banners/educacion-2-banner-recorte-1920x700.webp",
    recuadro: "/recuadros/educacion-2-recuadro-recorte-900x900.webp"
  },
  {
    ...
    seoKeywords: ["doctorado en derecho", "estudiar doctorado en derecho en chalco", "doctorado en derecho en linea", "doctorado ejecutivo sabados", "posgrado avanzado derecho iua", "universidad doctorado los reyes", "investigacion juridica", "doctorado rvoe", "estudiar doctorado en derecho en IUA", "doctorado en derecho en línea", "posgrado en derecho", "investigación jurídica", "doctorado ejecutivo", "doctorado con RVOE"],
    ...
    banner: "/banners/sala-abogasdos-vacia-banner-recorte-1920x700.webp",
